...
public class History extends AppCompatActivity {
    ...
    ArrayList<Product> productsrecent = new ArrayList<Product>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filtered_products_recent_recyclerView = (RecyclerView) findViewById(R.id.history_recent_recyclerView);
        filtered_products_recent_recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL,false));
        final HistoryAdapter filtered_product_recent_adapter = new HistoryAdapter(productsrecent, this);
        filtered_products_recent_recyclerView.setAdapter(filtered_product_recent_adapter);
